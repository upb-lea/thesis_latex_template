 ...
 * The template for the dissertations is based on the [official EIM dissertation template](https://ei.uni-paderborn.de/studium/formalitaeten/promotionsausschuss).
